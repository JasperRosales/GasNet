...
export default function Sidebar({ activePage, onNavigate, open, onClose, isAdmin = false }) {
  const navItems = isAdmin ? ADMIN_NAV_ITEMS : POS_NAV_ITEMS
  ...
  return (
    <>
      ...
      <aside
        className={`fixed top-0 left-0 z-40 h-screen w-64 bg-brand-600 text-white flex flex-col transition-transform duration-300 ease-in-out lg:translate-x-0 ${
        ...
        <div className="relative flex items-center gap-3 px-6 py-5 border-b border-white/10">
          ...
          <div>
            ...
            <div className="text-[11px] text-white/50 -mt-0.5">
              {isAdmin ? 'Admin Portal' : 'POS Terminal'}
            </div>
          </div>
        </div>
