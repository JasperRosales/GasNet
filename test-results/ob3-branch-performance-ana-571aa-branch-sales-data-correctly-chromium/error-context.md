...
- Name: ob3\branch-performance-analysis.spec.js >> Ob3W3D2 — Branch Performance Analysis Service (End-to-End) >> should be analyzing branch sales data correctly
- Location: e2e\ob3\branch-performance-analysis.spec.js:14:3
