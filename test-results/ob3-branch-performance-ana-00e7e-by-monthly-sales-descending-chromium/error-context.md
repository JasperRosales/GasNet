...
- Name: ob3\branch-performance-analysis.spec.js >> Ob3W3D2 — Branch Performance Analysis Service (End-to-End) >> UI branch comparison should be sorted by monthly sales descending
- Location: e2e\ob3\branch-performance-analysis.spec.js:60:3
