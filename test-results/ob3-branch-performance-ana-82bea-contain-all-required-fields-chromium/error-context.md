...
- Name: ob3\branch-performance-analysis.spec.js >> Ob3W3D2 — Branch Performance Analysis Service (End-to-End) >> API response should contain all required fields
- Location: e2e\ob3\branch-performance-analysis.spec.js:78:3
